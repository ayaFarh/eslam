...
export default function Home() {
  ...
  return  (
    ...
    <div className='w-[150%] md:w-[40%] absolute top-1/2 left-[-120px] md:top-0 md:left-0 md:rotate-[0deg] rotate-[20deg] md:z-0 z-10  flex flex-col  items-center justify-center md:h-full h-[70%] bg-gray-300 bg-gray-300/50 md:bg-black/0'>
  <div className='text-white font-bold text-center md-rotate-[0deg] rotate-[-20deg] md:rotate-[0deg] md:relative absolute top-[25%] left-[30%] md:top-0 md:left-0'>
  <h2 className='text-2xl text-black'>Hi👋</h2>
  <h1 className='my-2 text-3xl text-flicker-in-glow text-black' >I am Eslam </h1>
  <p>Fullstack <span className='text-black'>.Net</span> Software Engineer </p>
